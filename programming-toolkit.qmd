...
This section contains an overview about the programming toolkit you will need for our labs. 

You will need to:

1. Install a [SQL](@sec-sql) database (MySQL and MySQL Workbench)
2. Install and setup [Anaconda](@sec-anaconda) (includes Python and some toolkits)
3. Install [Visual Studio Code](@sec-vscode) (a code editor) and some extensions
4. Prepare your work environment with an environment file (which ususally inlcudes passwords and API-keys)
5. Create an acount at [GitHub](@sec-github) (for software development and version control)

Please read all the instructions and complete the tasks listed in the following two sections ("Fundamentals" and "Tools").

:::{.callout-tip}
If you aren't familiar with the terminal, you may want to look at this [short introduction](@sec-terminal)
:::
...
After you have installed and updated Anaconda, you can install the modules we need for our labs in a new environment. 
...
### Stackoverflow {#sec-stackoverflow}
...
### Command-line interface {#sec-terminal}
