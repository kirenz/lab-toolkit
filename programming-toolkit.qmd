...
1. Install [Anaconda](@sec-anaconda) (includes Python and some toolkits)
2. Install [Visual Studio Code](@sec-vscode) (a code editor)
3. Create an acount at [GitHub](@sec-github) (for software development and version control)
